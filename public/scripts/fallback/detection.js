(function() {
    ...
    if (isChromeOniPad == false && ctx && ctx !== undefined) {// Detection for ipad and chrome
        document.write('<script type="text/javascript" src="public/scripts/application.js"></script>');
        //document.write('<link type="text/css" rel="stylesheet" media="all" href="/style/application.css" />');
    }
    // fallback - no webgl
    else {
        document.write('<script type="text/javascript" src="public/scripts/fallback/fallback.js"></script>');
