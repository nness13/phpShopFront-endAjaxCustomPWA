                    ...
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-front this-card" >
                            <form action="/account/register" method="post" name="register">
                                <a onclick="flip('#flipandslide')" class="btn btn-black btn-full">вже маєте обліковий запис?</a>
                                <div>Створити новий обліковий запис:</div>

                                <div class="btn btn-primary btn-active btn-fifty btn-inline">Створити</div>
                                        
                                <div class="btn btn-black btn-fifty btn-inline" onclick="flip('#flipandslide')" id="flipandslide">Увійти</div>
                        ...
                        <div class="flip-card-back this-card">
                            ...
                            <a onclick="backflip('#backflipandslide')" class="btn btn-black btn-full">створити обліковий запис</a>
                                <div>Заповніть форму щоб авторизуватись:</div>

                                    <div class="btn btn-black btn-fifty btn-inline" onclick="backflip('#backflipandslide')" id="backflipandslide">Створити</div>
